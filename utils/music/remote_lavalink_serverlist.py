# pip install requests or add requests to requirements.txt (if you don't have it, create that file with requests in it).
import re
import traceback
...
def get_lavalink_servers():
    ...
    print(f"Downloading lavalink server list from: https://lavalink-list.darrennathanael.com/\n"
          "Note: Since these lavalink servers are public, they may experience instability.")
